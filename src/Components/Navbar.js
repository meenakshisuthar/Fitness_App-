  ...
  return (
    <Stack direction='row' px="20px" sx={{gap: { sm: '60px', xs: '40px'}, mt: { sm: '32px', xs: '20px'}}}>
      ...
      <Stack direction='row' gap="40px" fontSize='24px' alignItems='flex-end'>
        <Link to='/' style={{ textDecoration: 'none', color: '#3A1212', borderBottom: '3px solid var(--primary-color)' }}>Home</Link>
        <a href="#exercises" style={{ textDecoration: 'none', color: '#3A1212'}}>Exercises</a>
        <Link to="/BmiCalculator" style={{ textDecoration: 'none', color: 'black' }}>BMI Calculator</Link>
      </Stack>
    </Stack>
  )
}
